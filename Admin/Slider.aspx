<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Slider.aspx.cs" Inherits="Admin_Slider" %>
                                ...
                                <div class="forms-inner">
                                    <div class="set-1">
                                        <div class="graph-2 general">
                                            <h3 class="inner-tittle two">Slider Detail</h3>
                                            <div class="grid-1">
                                                <div class="form-body">
                        ...
                        <asp:Panel ID="pnlTabUpdate" runat="server">
                            <div class="forms-main">
                                <div class="forms-inner">
                                    <div class="set-1">
                                        <div class="graph-2 general">
                                            <h3 class="inner-tittle two">Slider Update Details  </h3>
                                            <div class="grid-1">
                                                <div class="form-body">
                                                    <div class="form-horizontal">
                                                        <div class="form-group">
                        ...
                        <asp:Panel ID="pnlView" runat="server">
                            <div class="outter-wp">
                                ...
                                <div class="sub-heard-part">
                                    ...
                                    <h3 class="inner-tittle two">Slider Table </h3>
                                    <div class="graph">
                                        <div class="tables">
                                                    ...
                                                    <asp:Repeater ID="rptViewUser" runat="server" OnItemCommand="rptViewUser_ItemCommand">
                                                        <ItemTemplate>
                                                            <tr>
                                                                 <td><%#Eval("name") %></td>
                                                                <td>
                                                                    <img id="imgSubmit" width="100" height="100" src="../Admin/Slider/<%#Eval("[\"image\"]") %> " /></td>
